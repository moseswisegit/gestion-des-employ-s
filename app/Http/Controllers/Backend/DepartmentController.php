...
class DepartmentController extends Controller
{
    ...
    public function store(DepartmentStoreRequest $request)
    {
        ...
        return redirect()->route('departments.index')->with('message','departments created succefuly');
    ...
    public function update(DepartmentStoreRequest $request, Department $department)
    {
        ...
        return redirect()->route('departments.index')->with('message','departments updated succefuly');
